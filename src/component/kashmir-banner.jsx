...
import Banner from '../assets/img/kashmir/3.jpg'
const KashmirBanner = () => {
  return (
    <div>
                ...
                <div className="col-lg-6 col-md-10" >
                    <div className="banner-inner text-center position-relative">
                       ...
                       {/* <h5 className='mb-3' data-aos="fade-up" data-aos-offset="10">Welcome to Kerala </h5> */}
                        <h2 className='sub-head mb-3 mt-3 text-uppercase' data-aos="fade-up" data-aos-offset="10">Amazing tour <br /> Kashmir</h2>
                       </div>
                    </div>
                </div>
            </div>
